# Digital Marketing Page Design

This repository contains the layout of a website page for a **digital marketing**. The design is created using HTML, CSS, and JavaScript. The objective of this project is to develop a visually attractive and functional page, representing the services and identity of a **digital marketing**.
...
```bash
git clone https://github.com/adrjmiranda/digital-marketing-page-design
```
